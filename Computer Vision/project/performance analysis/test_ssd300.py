...
def create_dummy_images(num_images=20, size=(300, 300)):
...
def estimate_gflops_torchvision(model, input_size=(300, 300)):
    ...
    try:
        ...
        if 'ssdlite320_mobilenet' in model_name:
...
def test_model():
    ...
    test_images = create_dummy_images(50, size=(300, 300))
    ...
    gflops = estimate_gflops_torchvision(model, input_size=(300, 300))
